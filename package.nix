...
stdenv.mkDerivation {
  ...
  meta = {
    description = "Plymouth boot themes";
    longDescription = ''
      A variety of plymouth boot screens. Using the default value
      of `selected_themes` will install all themes.  Consider overriding
      this with a list of the string names of each theme to install.  Check
      ./shas.nix for available themes.
    '';
    homepage = "https://github.com/FNicon/plymouth_endfield";
